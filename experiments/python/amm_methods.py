...
METHOD_MITHRAL_CPP_IMP='MithralCppImp'
...
METHOD_TO_ESTIMATOR = {
    ...
    METHOD_MITHRAL_CPP_IMP: vq_amm.MithralMatmulCppImp,
}
...
MITHRAL_METHODS = (METHOD_MITHRALPQ, METHOD_MITHRAL, METHOD_OLD_MITHRALPQ, METHOD_MITHRAL_CPP_IMP)
...
USE_METHODS = ((METHOD_EXACT, METHOD_BOLT, METHOD_MITHRALPQ, METHOD_MITHRAL, METHOD_MITHRAL_CPP_IMP )
               + FAST_SKETCH_METHODS)
