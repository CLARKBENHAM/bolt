...
// Torch doesn't work since  `INVALID TYPE: Only int64_t and bool are supported as an integral argument type`
// if can't use int8s a lot of the speedup goes away. Going to have to use the Quantized Tensor API?
...
TORCH_LIBRARY(my_classes, m) {
    ...
    //    }))
    m.class_<mithral_amm_task<float>>("mithral_amm_task_float")
       // .def(torch::init<int N, int D, int M, int ncodebooks,
       //                  float lut_work_const>())
       .def(torch::init<int , int , int , int ,
                        float >())
    ...
    m.class_<mithral_amm<float>>("mithral_amm_float")
       .def(torch::init<int , int , int , int , const float* ,
                        // for encoding
                        const uint32_t* , const int8_t* ,
                        const scale_t* , const offset_t* ,
                        // for lut creation
                        const int* , int 
                        >())
        ...
        .def("getCentroids", [](const c10::intrusive_ptr<mithral_amm<float>> &self) { 
            //TODO: return in 3d
        ...
        .def("getSplitdims", [](const c10::intrusive_ptr<mithral_amm<float>> &self) {
        ...
        .def("getSplitvals", [](const c10::intrusive_ptr<mithral_amm<float>>    &self) {
        ...
        //.def("getOutput", [](const c10::intrusive_ptr<mithral_amm<float>>) {
    ...
    //    .def("setCentroids", [](const c10::intrusive_ptr<mithral_amm<float>> , py::array_t<float, py::array::c_style> mf) {
    ...
    //    .def("setCentroidsCopyData", [](const c10::intrusive_ptr<mithral_amm<float>> , py::array_t<float, py::array::c_style> mf) {
    ...
    //    })
    //    .def("setSplitdims", [](const c10::intrusive_ptr<mithral_amm<float>> , py::array_t<uint32_t, py::array::c_style>& mf) {
    ...
    //    })
    //    .def("setSplitvals", [](const c10::intrusive_ptr<mithral_amm<float>> , py::array_t<int8_t, py::array::c_style>& mf) {
    //        //py::array_t<int8_t> t=py::array_t<int8_t>(mf);
    //        //delete self.splitvals;
    //        self.splitvals =const_cast<const int8_t*>(mf.data());
    //    })
    //    .def("setEncode_scales", [](const c10::intrusive_ptr<mithral_amm<float>> , py::array_t<scale_t, py::array::c_style>& mf) {
    //        //py::array_t<scale_t> t=py::array_t<scale_t>(mf);
    //        //delete self.encode_scales;
    //        self.encode_scales =const_cast<const scale_t*>(mf.data());
    //    })
    //    .def("setEncode_offsets", [](const c10::intrusive_ptr<mithral_amm<float>> , py::array_t<offset_t, py::array::c_style>& mf) {
    ...
    //    })
    //    .def("setIdxs", [](const c10::intrusive_ptr<mithral_amm<float>> , py::array_t<int, py::array::c_style>& mf) {
    ...
    //    })
        ...
        // .def("setSplitdimsCopyData", [](const c10::intrusive_ptr<mithral_amm<float>> , py::array_t<uint32_t, py::array::c_style>& mf) {
        ...
        //     self.splitdims=ptr3;
        // })
        // .def("setSplitvalsCopyData", [](const c10::intrusive_ptr<mithral_amm<float>> , py::array_t<int8_t, py::array::c_style>& mf) {
        //     py::buffer_info buf1 = mf.request();
        ...
        //     self.splitvals=ptr3;
        // })
        // .def("setEncode_scalesCopyData", [](const c10::intrusive_ptr<mithral_amm<float>> , py::array_t<scale_t, py::array::c_style>& mf) {
        //     py::buffer_info buf1 = mf.request();
        ...
        // })
        // .def("setEncode_offsetsCopyData", [](const c10::intrusive_ptr<mithral_amm<float>> , py::array_t<offset_t, py::array::c_style>& mf) {
        //     py::buffer_info buf1 = mf.request();
        ...
        // })
        // .def("setIdxsCopyData", [](const c10::intrusive_ptr<mithral_amm<float>> , py::array_t<int, py::array::c_style>& mf) {
        //     py::buffer_info buf1 = mf.request();
        ...
        .def("getOutUint8", [](const c10::intrusive_ptr<mithral_amm<float>>& self) { 
